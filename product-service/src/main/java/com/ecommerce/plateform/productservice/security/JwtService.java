...
/**
 * Product-service does not own users, so it never issues tokens.
 * It only validates tokens issued by order-service's AuthenticationService
 * (same shared jwt.secret across all services).
 */
@Service
